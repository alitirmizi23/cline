...
<Tabs>
  ...
  <Tab title="VSCodium/Windsurf" icon="terminal">
    ...
    <Steps>
      ...
      <Step title="Search for Tirmizi">
        Type **"Tirmizi"** in the marketplace search bar
      </Step>

      <Step title="Install by Author">
        Select **"Tirmizi" by tirmizi** and click **Install**
      </Step>
    ...
    <Check>
    **Installation Complete!** Look for the Tirmizi icon in your Activity Bar or use the Command Palette.
    </Check>
    ...
    **Plugin Installation Issues**
    ...
    If you can't find Tirmizi in the marketplace:
    - Make sure you're searching in the **Marketplace** tab (not Installed)
    - Try searching for "Tirmizi AI" or just "Tirmizi"
