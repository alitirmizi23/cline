...
The Tirmizi extension exposes an API that can be used by other extensions. To use this API in your extension:
...
3. Get access to the API with the following code:
    ...
    ```ts
    const clineExtension = vscode.extensions.getExtension<ClineAPI>("tirmizi.tirmizi")
    ...
    **Note:** To ensure that the `tirmizi.tirmizi` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:
